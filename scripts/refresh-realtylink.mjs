...
// Realtylink normally omits cooling when it is unknown. Absence is not proof
// that a home has no AC, so only retain an affirmative match from the page.
for(const candidate of candidates)candidate.ac=candidate.ac===true?true:null;
